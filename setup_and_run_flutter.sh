...
echo "Starting automated setup for FloatStream.io with Flutter Web frontend..."
...
# Check if flowStream directory exists
if [ ! -d "flowstream" ]; then
    echo "Error: flowstream directory not found. Please ensure your Flutter app is in the current directory."
    exit 1
fi
...
# Check and kill processes on ports 8000 and 8080 if they're in use
...
# Run the Flutter Web frontend
echo "Starting the Flutter Web frontend..."
cd flowStream
...
echo "Access the Flutter Web frontend at http://localhost:8080"
